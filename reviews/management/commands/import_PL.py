...
class Command(BaseCommand):
    help = "Import Premier League games from ESPN"
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            "Fetching Premier League games from ESPN..."
        )
        ...
        self.stdout.write(
            f"Found {len(events)} Premier League games."
        )
        ...
        self.stdout.write("Premier League import complete.")
